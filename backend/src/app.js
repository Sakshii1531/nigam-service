...
import { jobRouter } from './modules/service-provider/job.routes.js';
import { claimRouter as serviceProviderClaimRouter } from './modules/service-provider/claim.routes.js';
import { inventoryRouter } from './modules/service-provider/inventory.routes.js';
import { earningsRouter } from './modules/service-provider/earnings.routes.js';
import { academyRouter } from './modules/service-provider/academy.routes.js';
...
import { reportsRouter } from './modules/super-admin/marginReport.routes.js';
import { plansAdminRouter } from './modules/super-admin/plansAdmin.routes.js';
...
export function createApp() {
  ...
  app.use('/api/v1/service-provider/register', serviceProviderRegistrationRouter);
  ...
  app.use('/api/v1/service-provider/academy', academyRouter);
  ...
  app.use('/api/v1/super-admin/reports', reportsRouter);
  app.use('/api/v1/super-admin/plans', plansAdminRouter);
