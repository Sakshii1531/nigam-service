...
export const SERVICE_REQUEST_TRANSITIONS = Object.freeze({
  ...
  'Engineer Reached': ['Diagnosis Done', 'Repair Completed', 'Customer NA', 'Spare Required'],
  'Diagnosis Done': ['Spare Required', 'Repair Completed', 'Spare Ordered'],
  'Spare Required': ['Spare Ordered', 'Spare Received', 'Cancelled'],
  'Spare Ordered': ['Spare Received', 'Visit Scheduled', 'Cancelled'],
  'Spare Received': ['Visit Scheduled', 'Repair Completed', 'Engineer Reached'],
