...
export const SERVICE_REQUEST_TRANSITIONS = Object.freeze({
  ...
  'Engineer Reached': ['Diagnosis Done', 'Repair Completed', 'Customer Confirmation', 'Customer NA', 'Spare Required'],
  'Diagnosis Done': ['Spare Required', 'Repair Completed', 'Spare Ordered', 'Customer Confirmation'],
  'Spare Required': ['Spare Ordered', 'Spare Received', 'Cancelled'],
  'Spare Ordered': ['Spare Received', 'Visit Scheduled', 'Cancelled'],
  'Spare Received': ['Visit Scheduled', 'Repair Completed', 'Engineer Reached', 'Customer Confirmation'],
  'Repair Completed': ['Customer Confirmation', 'Closed'],
...
export const JOB_STEP_TRANSITIONS = Object.freeze({
  ...
  revisit_arrived: ['revisit_complete', 'revisit_billing', 'revisit_payment', 'revisit_otp', 'completed'],
  revisit_complete: ['revisit_billing', 'revisit_payment', 'revisit_otp', 'repaircomplete', 'completed'],
  revisit_billing: ['revisit_payment', 'revisit_otp', 'completed', 'awaitingpayment'],
  revisit_payment: ['revisit_otp', 'completed', 'awaitingpayment'],
  revisit_otp: ['completed'],
  repaircomplete: ['billing', 'completed'],
