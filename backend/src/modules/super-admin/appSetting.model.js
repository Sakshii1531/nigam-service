...
// Flat key/value config store per app, e.g. app='service provider', key='autoAssign', value=true.
// Simple-schema/wide-rows over one giant settings blob — new toggles need no migration.
const appSettingSchema = new mongoose.Schema(
  {
    app: { type: String, enum: ['customer', 'service_provider'], required: true, index: true },
