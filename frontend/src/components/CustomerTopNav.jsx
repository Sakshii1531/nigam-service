  ...
  return (
    <nav className="hidden lg:flex fixed top-0 left-0 right-0 z-50 h-20 bg-brand-navy/95 backdrop-blur-md border-b border-white/10 shadow-[0_4px_20px_rgba(5,31,66,0.25)]">
      <div className="max-w-screen-2xl mx-auto w-full px-6 md:px-10 lg:px-16 xl:px-20 flex items-center justify-between gap-4">
        ...
        <div className="flex bg-black/30 p-1.5 rounded-full border border-white/10 shadow-inner items-center shrink-0">
          <button
            onClick={() => navigate("/dashboard")}
        ...
        <div className="flex items-center gap-2 lg:gap-3 bg-white/5 p-1.5 rounded-2xl border border-white/10 backdrop-blur-xs shrink-0">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3.5 lg:px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 cursor-pointer ${
                  isActive
                    ? "bg-linear-to-r from-brand-yellow to-brand-yellow/80 text-brand-navy shadow-[0_2px_10px_rgba(255,212,0,0.3)] scale-[1.02]"
        ...
        <button
          ...
          className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/12 border border-white/10 transition-all text-left cursor-pointer group shrink-0"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1">
              <span className="text-xs font-bold text-white group-hover:text-brand-yellow transition-colors max-w-35 truncate">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            <div className="w-7 h-7 rounded-lg bg-linear-to-tr from-brand-yellow to-brand-yellow/80 text-brand-navy flex items-center justify-center font-black text-xs shadow-xs">
              {userInitial}
            </div>
            <span className="text-xs font-bold text-slate-200 group-hover:text-white max-w-25 truncate">
              {firstName}
            </span>
