...
import {
  syncOnLogin as syncCartOnLogin,
  clearLocalOnLogout as clearLocalCart,
} from "../lib/cartStore";
  ...
  try {
    ...
    if (legacy) {
      ...
      if (
        parsed?.role === portal ||
        (portal === "super_admin" &&
          (parsed?.role === "super_admin" || parsed?.role === "asm"))
      ) {
        return parsed;
      }
      if (
