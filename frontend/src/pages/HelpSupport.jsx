  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      ...
      <div className="flex-1 max-w-screen-2xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-10">
        ...
        {/* Hero Search Section */}
        <div className="bg-linear-to-br from-brand-navy via-[#0B4EA2] to-brand-blue rounded-[32px] p-8 md:p-12 text-white relative overflow-hidden shadow-xl text-center flex flex-col items-center gap-4">
