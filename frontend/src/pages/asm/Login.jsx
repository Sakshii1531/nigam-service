      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm flex items-center justify-center gap-1">
            <MapPin size={14} className="text-[#0D47A1]" /> ASM Portal
          </p>
        </div>

        <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
          <div className="mb-6 text-center">
            <h2 className="text-xl font-semibold text-gray-800">Zone Manager Login</h2>
            <p className="text-gray-500 text-sm mt-1">Sign in to manage your zone's service providers</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1.5 block">Email or Phone</label>
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <button type="button" onClick={() => navigate('/asm/forgot-password')} className="text-xs text-[#0D47A1] hover:underline font-medium">Forgot Password?</button>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                  <Lock size={18} />
