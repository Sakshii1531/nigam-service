...
const Assignment = () => {
  ...
  const handleAssign = () => {
    if (!selectedRequest || !selectedTech) {
      alert('Please select both a request and a technician.');
      return;
    }
    alert(`Assigned ${selectedTech.name} to Request ${selectedRequest.id}`);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E2E8F0] flex flex-col h-[calc(100vh-12rem)]">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="bg-yellow-50 text-yellow-600 px-2.5 py-1 rounded-full text-xs font-medium">{requests.length} Pending</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#E2E8F0] flex flex-col h-[calc(100vh-12rem)]">
              ...
              <div className="mt-4 pt-4 border-t border-[#E2E8F0]">
                <div className="flex justify-between text-sm mb-4">
                  <div>
                    <p className="text-[#64748B]">Selected Request:</p>
                    <p className="font-bold text-[#1E293B]">{selectedRequest ? selectedRequest.id : 'None'}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-[#64748B]">Selected Tech:</p>
