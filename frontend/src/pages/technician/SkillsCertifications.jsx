...
const SkillsCertifications = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col pb-20 lg:pb-8 relative font-sans">
      ...
      <div className="hidden lg:block max-w-screen-xl mx-auto w-full px-6 xl:px-8 pt-6 pb-2">
        <div className="flex items-center justify-between bg-white rounded-3xl p-5 border border-slate-200/80 shadow-2xs">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h1 className="text-xl font-black text-[#052355] tracking-tight">Skills & Certifications</h1>
              <p className="text-xs text-slate-500 font-medium mt-0.5">Verified trade expertise, appliance competencies and certifications</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {error && (
        <div className="mx-4 mt-4 max-w-screen-xl mx-auto w-full bg-rose-50 border border-rose-200 rounded-xl px-3 py-2 text-[11px] font-semibold text-rose-600">
          {error}
        </div>
      )}
