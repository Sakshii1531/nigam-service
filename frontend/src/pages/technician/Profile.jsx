        ...
        <div className="flex flex-col border-t border-slate-200 mt-2">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-xs font-medium text-[#052355]">AI Assistant</h4>
                <p className="text-[10px] text-slate-600 font-normal mt-0.5">Chat with diagnostic assistant</p>
              </div>
            </div>
            <ChevronRight className="h-4.5 w-4.5 text-slate-500" />
          </button>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-xs font-medium text-[#052355]">Payout Settings</h4>
                <p className="text-[10px] text-slate-600 font-normal mt-0.5">Manage bank & payouts</p>
              </div>
            </div>
            <ChevronRight className="h-4.5 w-4.5 text-slate-500" />
          </button>
