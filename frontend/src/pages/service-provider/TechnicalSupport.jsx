      ...
      <div className="hidden lg:block max-w-screen-xl mx-auto w-full px-6 xl:px-8 pt-6 pb-2">
        <div className="flex items-center justify-between bg-white rounded-3xl p-5 border border-slate-200/80 shadow-2xs">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h1 className="text-xl font-black text-[#052355] tracking-tight">On-Site Technical Support</h1>
              <p className="text-xs text-slate-500 font-medium mt-0.5">Live engineer consultation and operations technical helpline</p>
            </div>
          </div>
        </div>
      </div>
