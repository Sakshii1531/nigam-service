...
const ServiceProviderApply = () => {
      ...
      try {
        ...
        if (cityList.length > 0) {
          setForm((prev) => ({
            ...
            state: cityList[0].state || prev.state,
          }));
        } else {
  ...
  const validateForm = () => {
    ...
    // Operating Territory validation (City)
    if (!form.city) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiRequest("/service-provider/register", {
        method: "POST",
        body: formData,
      });
    } catch (err) {
      ...
      <div className="w-full max-w-lg bg-white rounded-[30px] shadow-[0_20px_50px_rgba(5,150,105,0.05)] border border-slate-100 overflow-hidden flex flex-col pt-5 px-6 pb-6 relative z-10 my-6">
        ...
        <div className="flex flex-col items-center mb-4">
          ...
          <p className="text-slate-500 text-xs mt-1 text-center">
            Fill credentials & upload Aadhar card photos for verification
          </p>
        </div>
        ...
        <form
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <User
                  className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.name ? "text-rose-400" : "text-slate-400"}`}
                />
                <input
                  type="text"
                  name="name"
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Mail
                  className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.email ? "text-rose-400" : "text-slate-400"}`}
                />
                <input
                  type="email"
                  name="email"
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <Phone
                className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.phone ? "text-rose-400" : "text-slate-400"}`}
              />
              <input
                type="tel"
                name="phone"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Lock
                  className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.password ? "text-rose-400" : "text-slate-400"}`}
                />
                <input
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <Lock
                  className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.confirmPassword ? "text-rose-400" : "text-slate-400"}`}
                />
                <input
          ...
          <div
            ...
            <div
              ...
              <Briefcase
                className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.services ? "text-rose-400" : "text-slate-400"} pointer-events-none`}
              />
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <MapPin
                className={`absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 ${fieldErrors.city ? "text-rose-400" : "text-slate-400"} pointer-events-none z-10`}
              />
              <select
                name="city"
                value={form.city}
            ...
            {!citiesLoading && availableCities.length === 0 && (
              <p className="text-[11px] text-amber-600 mt-0.5">
                No service cities have been configured yet. Please check back
          ...
          <div
            ...
            <p className="text-[10px] text-slate-500">
              Upload clear front and back photos of your Aadhar Card for
