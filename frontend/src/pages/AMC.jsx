...
const AMC = () => {
  ...
  const getSubtitle = (appliance) => {
    ...
    if (n.includes("washing") || n.includes("machine"))
      return "your Washing Machine details";
  ...
  return (
    <div className="min-h-screen bg-bg-light flex flex-col pb-24 lg:pb-8 relative">
      {plansError && (
        <p className="mx-6 mt-4 bg-red-50 border border-red-200 rounded-xl px-3 py-2 text-[11px] font-bold text-red-700">
          {plansError}
        </p>
      )}
              ...
              <button
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <ChevronDown className="h-3.5 w-3.5 text-text-secondary group-hover:text-brand-blue group-hover:translate-y-0.5 transition-all shrink-0" />
                  </div>
                </div>
              </button>
...

                {
                  ...
                  icon: (
                    <div className="w-16 h-16 flex items-center justify-center text-[#0B4EA2]">
                      <svg
                        viewBox="0 0 100 100"
                        className="w-11 h-11 stroke-[#0B4EA2] stroke-[5.5] fill-none">
              ...
              <div className="w-[100px] h-[120px] flex-shrink-0 relative flex items-center justify-center rounded-2xl overflow-hidden bg-gradient-to-b from-brand-blue/90 to-[#0B4EA2] shadow-md">
                <div className="absolute inset-0 flex items-end justify-center pb-2">
                  <img
                    ...
                    alt="Water Purifier"
                    className="w-16 h-20 object-contain mix-blend-luminosity opacity-70"
                  />
                </div>
          ...
          <motion.div
            ...
            <div className="px-1">
              ...
              <p className="text-xs text-text-secondary font-semibold">
                Select an appliance for AMC plan
              </p>
            </div>
              ...
              {amcPlans.map((plan, idx) => {
                ...
                return (
                  <div
                    ...
                    onClick={() =>
                      navigate(
                        `/buy/amc/plans/${encodeURIComponent(selectedAppliance || "")}?plan=${idx}`,
                      )
                    }
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-slate-400 font-semibold block mt-0.5">
                      {invoiceFile
                        ? invoiceFile.name
                        : "Optional · JPG, PNG or PDF (Max 5MB)"}
                    </span>
                  </div>
                </div>
          ...
          <motion.div
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
              ...
              <div>
                ...
                <span className="text-xs font-black text-brand-blue block mt-0.5">
            ...
            <div className="flex flex-col items-center gap-2 mt-1">
              <button
                onClick={() =>
                  navigate(
                    `/buy/amc/payment/${encodeURIComponent(selectedAppliance || "")}/${selectedPlanIndex}`,
                  )
                }
          ...
          <motion.div
            ...
            <div className="flex flex-col gap-2.5 mt-2">
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    const res = await apiRequest(
                      "/warranty-amc/amc/subscriptions",
                      {
                        method: "POST",
                        auth: true,
                        body: {
                    ...
                    setPurchaseError(
                      err.message ||
                        "We could not activate this plan. You have not been charged — please try again.",
                    );
                    return;
                  }
                  navigate(
                    `/buy/amc/success/${encodeURIComponent(selectedAppliance || "")}/${selectedPlanIndex}`,
                  );
                }}
                ...
                Pay ₹{Number(selectedPlan.price || 0).toLocaleString(
                  "en-IN",
                )}{" "}
                Securely
              </button>
          ...
          <motion.div
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-text-secondary mt-1.5 font-medium">
                Your AMC is now active with Nigam Service.
              </p>
            </div>
